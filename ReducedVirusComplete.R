...
virustree<-read.nexus("~/DoublePhyloStan/VirusTreesNoCCReduced10.tree")
...
data<-read.csv("~/DoublePhyloStan/GeoNoHovNoWu.csv",header=T)
...
save(fit, file="~/Exp1/DoublePhyloStan/Results/ReducedFull10.Rdata")
